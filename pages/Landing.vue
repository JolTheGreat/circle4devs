  ...
  <div id="landing">
    <div class="title-page">
      <div class="title-page-content">
        <div class="title-wrapper">
          <h1>個人開発を一歩先へ</h1>
          <p>開発したアプリを共有しよう！</p>
          <button @click="start">Circleを開く</button>
        </div>
    ...
    <section id="about">
      ...
      <p>
        ...
        は、個人開発者同士がアプリを通じて交わるためのプラットフォームです。個人開発者が開発するアプリはWebアプリやモバイルアプリがありますが、それらの評価や使い勝手などはXやAppStoreといった様々な場所に散らばっています。小規模で開発されているアプリをまとめて、開発者にとっての最大の喜びである「使ってもらうこと」を満たすために、Circleは開発したアプリを発信し、他の開発者が使ってあげることで自分と似たような開発者たちに還元できる仕組みになっています。下記はこれから実装していきたい機能の一覧です。今のところ、他の個人開発者が作っているものを把握し、出版したアプリをXなどで共有することができます。上記のXとDiscordは整備中です！
      </p>
      ...
      <div id="like">
        <div>
          <h2>いいね、共感、評価</h2>
          <p>
            Circleでは、アプリやレビューに対する「いいね」や「共感」のリアクションを使って、開発者のアプリが評価されます。評価を元に、開発者はアプリに求められているものを把握し、改善に務めることができます。
          </p>
        </div>
      ...
      <div id="ranking">
        ...
        <div>
          <h2>ランキングと発見</h2>
          <p>
            Circleは、人気コンテンツやトピックをランキング化し、新たな発見をサポートし、あなたの興味に合ったコンテンツやトピックを簡単に見つけます。
          </p>
        </div>
      </div>
      <h2>さあ、Circleで新しい個人開発を始めましょう！</h2>
    </section>
  </div>
</template>
...
.title-page-content .title-wrapper {
  margin-bottom: 30px;
}
